...
export class Migration20230928143102 extends Migration {
  ...
  async down(): Promise<void> {
    ...
    this.addSql(
      "alter table \"reserves\" add constraint \"reserves_reason_check\" check (\"reason\" in ('fee', 'fee removed', 'overpay', 'shortpay', 'non-factored payment', 'non-factored payment removed', 'nonpayment', 'payment removed', 'payment edit increase', 'payment edit decrease', 'chargeback', 'overadvance', 'overadvance removed', 'client credit', 'client credit removed', 'client debit', 'release of funds', 'release of funds removed', 'release to 3rd party', 'release to 3rd party removed', 'direct payment by client', 'direct payment by client removed', 'broker claim', 'broker claim removed', 'write off', 'write off removed', 'balance transfer from', 'balance transfer from (positive)', 'balance transfer to', 'balance transfer to (positive)', 'additional payment'));",
    );
  }
}

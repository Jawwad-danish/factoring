...
export class Migration20250204102909 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'create table "notifications" ("id" uuid not null default uuid_generate_v4(), "created_at" timestamptz(3) not null, "created_by_id" uuid not null, "record_status" text check ("record_status" in (\'Active\', \'Inactive\')) not null default \'Active\', "updated_at" timestamptz(3) not null, "updated_by_id" uuid not null, "client_id" uuid not null, "medium" text check ("medium" in (\'email\', \'sms\')) not null, "recipient" varchar(255) null, "sent_at" timestamptz(0) null, "subject" varchar(255) null, "message" varchar(255) not null, "status" text check ("status" in (\'pending\', \'sent\', \'failed\', \'retrying\')) not null default \'pending\', constraint "notifications_pkey" primary key ("id"));',
    );
    this.addSql(
